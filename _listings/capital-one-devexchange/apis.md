...
- name: Capital One DevExchange Get all purchases by account and merchant
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/purchases/master/_listings/capital-one-devexchange/merchants-id-accounts-accountid-purchases-get-postman.md
x-common:
