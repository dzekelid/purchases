...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/purchases/master/_listings/aws-glacier/apis.md
...
- name: AWS Glacier API - Purchase  Provisioned  Capacity
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/purchases/master/_listings/aws-glacier/accountidprovisionedcapacity-post-openapi.md
- name: AWS Glacier API - Purchase  Provisioned  Capacity
  x-api-slug: accountidprovisionedcapacity-post
  description: |-
    Purchase Provisioned Capacity (POST provisioned-capacity)This operation purchases a provisioned capacity unit for an AWS account.RequestsTo purchase provisioned capacity unit for an AWS account send an HTTP POST
