...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/purchases/master/_listings/aws-rds/apis.md
...
- name: AWS RDS API - Purchase Reserved D B Instances Offering
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/purchases/master/_listings/aws-rds/actionpurchasereserveddbinstancesoffering-get-openapi.md
- name: AWS RDS API - Purchase Reserved D B Instances Offering
  x-api-slug: actionpurchasereserveddbinstancesoffering-get
  description: Purchases a reserved DB instance offering.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Database_AmazonRDS.png
